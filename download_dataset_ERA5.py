...
def add_targets(date):
    ...
    # Сохраняем результат
    ds_out.to_netcdf(f"w:/Postprocesing/Oleh Bedenok/GRAPHCAST/NOAA/TEST_Graphcast_14,05,2025-31,05,2025/dataset_ERA5/out_file_for_graphcast_{replaced}.nc", format="NETCDF3_64BIT")
